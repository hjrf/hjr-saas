mainApp.controller('userController',function ($scope,$http,$location,$window,$hjr) {
	//数据初始化
...
//编辑按钮事件
	...
	$scope.view = function(model) {
		...
		for (var key in model) {
			html += "<tr>";
			html += "<td title="+JSON.stringify(key)+">" + key + "</td>";
			html += "<td title="+JSON.stringify(model[key])+">" + model[key] + "</td>";
			html += "</tr>";
		}
		html+='</table>';
