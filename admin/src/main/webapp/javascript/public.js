...
//	'use strict';
	//左侧导航菜单效果
//	$('.side-menu li dt').click(setting(){
//		$(this).parents('li').addClass('open');
//		$(this).parents('.side-menu').find('.InitialPage').removeClass('active');
//		$(this).parents('li').siblings().removeClass('open');
//		
//	});
//	$('.side-menu dd a').click(setting(){
//		$(this).parents('li').addClass('open');
//		$(this).parents('li').siblings().removeClass('open')
//	});
//	$('.side-menu li').each(setting(){
//		//判断链接相当（当前页面导航样式）
...
//
//	//弹出层基础效果（确认/取消/关闭）
//	$('.JyesBtn').click(setting(){
//		$(this).parents('.dialog').hide();
//		if($('.mask').attr('display','block')){
//			$('.mask').hide();
//		}
//	});
//	$('.JnoBtn,.JclosePanel').click(setting(){
//		$(this).parents('.dialog').hide();
//		if($('.mask').attr('display','block')){
//			$('.mask').hide();
//		}
//	});
//	//基础弹出窗
//	$('.JopenPanel').click(setting(){
//		$('.dialog').show();
//		$('.dialog').css('box-shadow','0 0 30px #d2d2d2');
//	});
//	//带遮罩
//	$('.JopenMaskPanel').click(setting(){
//		$('.dialog,.mask').show();
...
//	});	
//	//安全退出
//	$('#JsSignOut').click(setting(){
//		layer.confirm('确定登出管理中心？', {
//		  title:'系统提示',
//		  btn: ['确定','取消']
//		}, setting(){
//		  location.href = 'templet/login.html';
//		});
//	});
//});
